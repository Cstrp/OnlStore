...
class Footer extends CompTemple {
  ...
  footerContent() {
    ...
    const footerTitle = new Create('h2', style.footerWrapperLogoTitle, footerLogoLink, 'Manga Store').element;
    ...
    const rsImg = new Create('img', style.footerWrapperLogoRSImg, footerLogoLinkRs, null, {
    ...
    const footerLogoGitImg = new Create('img', style.footerWrapperLogoImg, footerLogoGitLink, null, {
